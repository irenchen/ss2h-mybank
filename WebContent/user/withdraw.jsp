	...
	<div id="content" class="w3-container" style="height:300px;width:75%;margin-left:25%;">
		...
		<div class="w3-container" style="width:35%;min-width:200px;">
			<form action="user/withdraw" method="post">
				<label class="w3-label w3-black">請輸入提款金額</label>
				<input class="w3-input w3-pale-yellow" type="text" name="withdrawAmount" required/>
				<span class="w3-small w3-text-red"></span><br/>
				<input class="w3-btn w3-pink w3-right" type="submit" value="提款" /><br/> 
			</form> 
		</div>
