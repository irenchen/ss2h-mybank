	...
	<div id="content" class="w3-container" style="height:300px;width:75%;margin-left:25%;">
		...
		<div>
			<form action="user/modifyPass" method="post">
				<table>				
				<tr><td>舊密碼</td>
					<td><input class="w3-pale-yellow" type="password" name="oldPass" required /></td>
				</tr>
				<tr><td>新密碼</td>
					<td><input class="w3-pale-yellow" type="password" name="newPass" required /></td>
				</tr>
				<tr><td>確認新密碼</td>
					<td><input class="w3-pale-yellow" type="password" name="confirmPass" required /></td>
				</tr>
								
				</table>
			</form>
			<button id="btn1" class="w3-btn w3-pale-green w3-hover-red">取消</button>
			<button id="btn2" class="w3-btn w3-pale-blue w3-hover-yellow">更新密碼</button>
